...
#define FLAG_RECEIVED_MEGA_STONE    0x20 // Unused Flag
#define FLAG_RECEIVED_MEWTWO_DEBUG    0x21 // Unused Flag
...
#define FLAG_ENABLE_WILD_DOUBLE_BATTLES  0x264 // Unused Flag
